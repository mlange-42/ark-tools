...
//
// See also [Table]. See package [github.com/mlange-42/ark-tools/reporter] for usage examples.
type Row interface {
...
//
// See also [Row]. See package [github.com/mlange-42/ark-tools/reporter] for usage examples.
...
//
// See also [Grid]. See package [github.com/mlange-42/ark-tools/reporter] for usage examples.
...
//
// See also [Matrix] and [GridLayers]. See package [github.com/mlange-42/ark-tools/reporter] for usage examples.
...
//
// See also [Grid], [Matrix] and [GridLayers]. See package [github.com/mlange-42/ark-tools/reporter] for usage examples.
